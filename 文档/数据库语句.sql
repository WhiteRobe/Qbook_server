...
AVATAR VARCHAR(40) DEFAULT 'defaultAVATAR.jpg',
PRIMARY KEY(UID)
);

create table GoodsInfo(
IUID INT UNSIGNED AUTO_INCREMENT,
INAME VARCHAR(50) NOT NULL,
AUTHOR VARCHAR(100) NOT NULL,
PUBLISHER VARCHAR(40) NOT NULL,
DESCS VARCHAR(300) DEFAULT '无简介',
PRICE DOUBLE NOT NULL,
DISCOUNT TINYINT UNSIGNED NOT NULL,
COVER_PIC VARCHAR(256) DEFAULT 'default_book_cover.jpg',
ONSALE BOOLEAN DEFAULT true,
SALED INT UNSIGNED DEFAULT 0,
...
OSTATUS VARCHAR(10) DEFAULT '已提交',
...
IUID INT UNSIGNED NOT NULL,
PRICE DOUBLE NOT NULL,
DISCOUNT TINYINT UNSIGNED NOT NULL,
AMOUNT TINYINT UNSIGNED DEFAULT 1,
PRIMARY KEY(ORDERID,IUID),
FOREIGN KEY(ORDERID) REFERENCES OrderInfo(ORDERID),
FOREIGN KEY(IUID) REFERENCES GoodsInfo(IUID)
);
